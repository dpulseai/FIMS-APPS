  ...
  const handleSaveAsDraft = async () => {
    try {
      ...
      const formData = {
        ...
        location_visit_date: locationVisitDate || null,
        ...
        gp_work_serial_no: gpWorkSerialNo,
        gp_work_scheme_name: gpWorkSchemeName,
        gp_work_type: gpWorkType,
        gp_work_estimated_amount: gpWorkEstimatedAmount ? parseFloat(gpWorkEstimatedAmount) : null,
        gp_work_grant_received: gpWorkGrantReceived ? parseFloat(gpWorkGrantReceived) : null,
        gp_work_expenditure: gpWorkExpenditure ? parseFloat(gpWorkExpenditure) : null,
